<!-- READMEFLOW:BEGIN -->
# @promethean-os/enso-agent-communication

Enso Protocol-based agent communication layer for coordinated AI agent collaboration
...
```bash
pnpm -w add -D @promethean-os/enso-agent-communication
```
